...
; *****************************************************************************
; ** COPIED FROM llvm/test/Transforms/LoopInterchange/loop-interchange-6d.ll **
; *****************************************************************************
;
...
; CHECK-NEXT:  Context for (sext i32 %20 to i64):
; CHECK-NEXT:    (sext i32 %20 to i64) sge 1
; CHECK-NEXT:    (sext i32 %20 to i64) sle 54
; CHECK-NEXT:  Context for (zext i32 (0 smax %23) to i64):
; CHECK-NEXT:    (zext i32 (0 smax %23) to i64) sge 1
; CHECK-NEXT:    (zext i32 (0 smax %23) to i64) sle 2501
