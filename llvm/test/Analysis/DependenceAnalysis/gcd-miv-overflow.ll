...
; // 5*1844674407370955161 == 9223372036854775805 == INT64_MAX + 1
;
; for (i = 0; i < 1844674407370955161; i++)
;   for (j = 0; j < 2; j++) {
...
;   }
;
; memory accesses                 | i == 1844674407370955161, j == 1
; --------------------------------|----------------------------------
; A[5*i - 9223372036854775805*j]  | A[-5]
; A[-5*i + 9223372036854775796*j] | A[-5]
;
...
loop.i.latch:
  ...
  %ec.i = icmp eq i64 %i, 1844674407370955161
